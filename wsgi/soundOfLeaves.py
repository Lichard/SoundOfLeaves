...
#import lxml
#import sys
#sys.path.append(r'C:\Python27\MyModules')
#import AlchemyAPI
...
data = json.load(urllib2.urlopen('http://access.alchemyapi.com/calls/html/HTMLGetTextSentiment')
...
#resp, content = hello.request("http://www.gutenberg.org/cache/epub/1661/pg1661.xt", "POST", urlencode(data)
